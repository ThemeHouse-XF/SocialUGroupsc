...
/**
 * Route prefix handler for social user groups in the public system.
 */
class ThemeHouse_SocialUGroups_Route_Prefix_SocialUserGroups implements XenForo_Route_Interface
{
